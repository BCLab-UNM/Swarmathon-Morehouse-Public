...
int main(int argc, char **argv) {
    ...
    goalLocation.theta = (M_PI) / 2; // set initial heading to 0 rad.
...
void targetHandler(const shared_messages::TagsImage::ConstPtr& message) 
{
	//tagCheck is an integer that will change value if the rover returns
    //to its return location and finds no tags.
    tagCheck = 0;
	...
	else if (targetDetected.data == -1) 
	{
        ...
        do 
        {
			...
			//Set the x and y coordinates to return to
